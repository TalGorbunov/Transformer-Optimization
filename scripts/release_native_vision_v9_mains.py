"""CPU release of matched V9 mains from frozen checks and measured profiles."""
...
from scripts import train_native_vision_v9 as train
from scripts.stage_native_vision_v7_features import need,read,sha
OWN=('scripts/release_native_vision_v9_mains.py','slurm/native_vision_v9_main_release.sbatch')
...
def main():
    ...
    for directory in a.profiles:
        ...
        need(s['profile'] and s['seed']==12 and s['passed'] and s['steps']==32 and s['no_dev_or_test_evaluation']
