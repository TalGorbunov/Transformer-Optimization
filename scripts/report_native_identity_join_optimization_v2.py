...
def pilot():
    from scripts import diagnose_native_identity_join_optimization_v2 as module
    return module
...
def release(args,out,frozen):
    ...
    passed=seconds<=840 and budget['projected_total_with_main_reservations']<=4500;budget['passed']=passed
    ...
    value=dict(passed=passed,completed=True,protocol='identity_join_optimization_main_release',source_sha256=frozen,
        ...
        pooled_projection=projection,campaign_budget=budget,per_main_seconds_cap=840,campaign_gpu_seconds_cap=4500,
