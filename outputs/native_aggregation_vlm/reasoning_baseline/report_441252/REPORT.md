...
| Model | Endpoint | N16 exact | N32/N64 exact | OOD parsed | OOD truncated | Parsed OOD MAE |
|---|---|---:|---:|---:|---:|---:|
| cosmos | direct32 | 4/18 | 4/36 | 36/36 | 0/36 | 5.139 (36) |
| cosmos | reason128 | 0/18 | 0/36 | 0/36 | 36/36 | — |
| cosmos | reason512 | 4/18 | 1/36 | 8/36 | 28/36 | 7.000 (8) |

cosmos: primary difference -8.33 pp (paired-anchor interval [-22.22, +0.00]); 5 pp descriptive screen: False. N16 difference +0.00 pp.
Measured total 747.2s; generation 698.5s; 24975 generated tokens.
direct: 52.6s generation, 493 tokens (9.1/scene), mean prompt 7481.0 tokens.
reason: 645.9s generation, 24482 tokens (453.4/scene), mean prompt 7478.0 tokens.
