"""CPU-Slurm checks of the V8 paired schedule and adversarial metadata cases."""
...
from scripts.native_vision_v8_pairs import self_test


class V8PairedScheduleTests(unittest.TestCase):
