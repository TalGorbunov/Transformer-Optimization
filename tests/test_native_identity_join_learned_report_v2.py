...
from scripts import report_native_identity_join_learned_v2 as report
...
class ReporterTests(unittest.TestCase):
    ...
    def test_failed_zero_accounting_and_double_count_protection(self):
        ...
        main=raw.replace(name,'identity_join_learned_main').replace('|7|','|3300|').replace('10:00:07','10:55:00')
        self.assertEqual(report.accounting_rows(main)['allocated_gpu_seconds'],3300)
        with self.assertRaises(ValueError):report.accounting_rows(main.replace('|3300|','|3301|'))
